...
if ($_POST)
{
  ...
  if(isset($_POST['calculate1']) && $_POST['calculate1'] ){$value1= "checked";}
  if(isset($_POST['calculate2']) && $_POST['calculate2']){$value2= "checked";}
  if(isset($_POST['calculate3']) && $_POST['calculate3'] ){$value3= "checked";}
  if(isset($_POST['calculate4']) && $_POST['calculate4']){$value4= "checked";}
  $a= $_POST['a'];
  $b= $_POST['b'];
  if($a1=="addition"){
    $obj= new adding();
...
<body>
  ...
  <input type="checkbox"  name="calculate1" <?php echo $value1;?> value="addition">
  <label for="addition">addition</label><br>
  <input type="checkbox"  name="calculate2" <?php echo $value2;?> value="subtraction">
  <label for="subtraction">subtraction</label><br>
  <input type="checkbox"  name="calculate3" <?php echo $value3;?> value="multiplication">
  <label for="multiplication">multiplication</label><br>
  <input type="checkbox"  name="calculate4" <?php echo $value4;?> value="division">
  <label for="division">division</label></td></tr><br>
  <tr><td>
  <input type="submit" value="submit" name=""><br></td></tr>
  <tr><td> <?php echo  $result1;?></td> </tr><tr><td> <?php echo  $result2;?></td></tr><tr><td> <?php echo  $result3;?></td></tr><tr><td> <?php echo  $result4;?></td></center></tr>
  </form></table></center>
</body>
</html>
